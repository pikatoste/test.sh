...
assert_equals "$PRUNEFILE" "${PRUNE_PATH_CACHE[$PRUNEFILE]}"
...
PRUNE_PATH_CACHE=([/hola/pepe]=/hola/pepe)
SUBTEST= PRUNE_PATH="*/" INITIALIZE_SOURCE_CACHE= init_prune_path_cache
assert_equals pepe "${PRUNE_PATH_CACHE[/hola/pepe]}"
