...
---
# Output of test_regression_30.sh
...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: Regression #30: run_test_script() stalls when the there's an error in the function
/home/runner/work/test.sh/test.sh/runtest/test/../test.sh: line 506: /home/runner/work/test.sh/test.sh/runtest/test/__I_dont_exist__: No such file or directory
<span class="f4">[test.sh]</span> Expected failure:
<span class="f4">[test.sh]</span> implicit exception: Error in run_test_script(runtest/test.sh:506): '&quot;$test_script&quot; &quot;$@&quot;' exited with status 127
<span class="f4">[test.sh]</span>  at _eval(runtest/test.sh:350)
<span class="f4">[test.sh]</span>  at assert_failure(runtest/test.sh:702)
<span class="f4">[test.sh]</span>  at main(runtest/test/test_regression_30.sh:6)
<span class="f2">[test.sh]</span> PASSED: Regression #30: run_test_script() stalls when the there's an error in the function
</pre>
</body>
</html>
