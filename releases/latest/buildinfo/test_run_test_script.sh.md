---
layout: release
version: 0.1.0-SNAPSHOT-c7dc7fa
---
# Output of test_run_test_script.sh
...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: run_test_script() interprets relative paths from the current script (#63)
<span class="f2">[test.sh]</span> PASSED: run_test_script() interprets relative paths from the current script (#63)
</pre>
</body>
</html>
