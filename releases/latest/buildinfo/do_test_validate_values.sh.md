---
layout: release
version: 0.1.0-SNAPSHOT-8eeb9a4
---
# Output of do_test_validate_values.sh
...
[test.sh] implicit exception: Error in validate_values(runtest/test.sh:724): 'false' exited with status 1
[test.sh]  at load_config(runtest/test.sh:728)
[test.sh]  at setup_self_runner(runtest/test.sh:774)
[test.sh]  at source(runtest/test.sh:880)
[test.sh]  at main(runtest/test/do_test_validate_values.sh:2)
</pre>
</body>
</html>
