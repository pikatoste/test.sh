...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: When executed, test.sh should output the version and github project
This is test.sh version 0.1.0-SNAPSHOT-9f8e143
See https://github.com/pikatoste/test.sh
<span class="f2">[test.sh]</span> PASSED: When executed, test.sh should output the version and github project
</pre>
</body>
</html>
