...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: #74: Use TMPDIR for temporary files
<span class="f2">* #74: Use TMPDIR for temporary files</span>
<span class="f4">[test.sh]</span> Start test: #74: Use TMPDIR for temporary files
/home/runner/work/test.sh/test.sh/runtest/test/tmp/tsh-5118-exceptions
/home/runner/work/test.sh/test.sh/runtest/test/tmp/tsh-5118-pipe
<span class="f2">* #74: Use TMPDIR for temporary files</span>
<span class="f2">[test.sh]</span> PASSED: #74: Use TMPDIR for temporary files
<span class="f2">[test.sh]</span> PASSED: #74: Use TMPDIR for temporary files
</pre>
</body>
</html>
