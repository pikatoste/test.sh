...
---
# Output of do_test_assert_71.sh
...
<body class="f9 b9">
<pre>
[test.sh] assert exception: Assertion failed: first, expected success but got failure in: 'false'
[test.sh] Caused by:
[test.sh] implicit exception: Error in _eval(test.sh:350): 'false' exited with status 1
[test.sh] assert exception: Assertion failed: second, expected success but got failure in: 'false'
[test.sh] Caused by:
[test.sh] implicit exception: Error in _eval(test.sh:350): 'false' exited with status 1
[test.sh] Start test: test_01
[test.sh] assert exception: Assertion failed: test_01, expected success but got failure in: 'false'
[test.sh] Caused by:
[test.sh] implicit exception: Error in _eval(test.sh:350): 'false' exited with status 1
[test.sh] assert exception: Assertion failed: teardown_test, expected success but got failure in: 'false'
[test.sh] Caused by:
[test.sh] implicit exception: Error in _eval(test.sh:350): 'false' exited with status 1
[test.sh] FAILED: test_01
[test.sh] assert exception: Assertion failed: teardown_test_suite, expected success but got failure in: 'false'
[test.sh] Caused by:
[test.sh] implicit exception: Error in _eval(test.sh:350): 'false' exited with status 1
[test.sh] 1 test(s) failed
</pre>
</body>
</html>
