...
---
# Output of test_config_FAIL_FAST.sh
...
<span class="f4">[test.sh]</span> Start test: test_fail
<span class="f1">[test.sh]</span> implicit exception: Error in test_01(runtest/test/test_config_FAIL_FAST.sh:8): 'false' exited with status 1
...
<span class="f1">[test.sh]</span>  at main(runtest/test/test_config_FAIL_FAST.sh:28)
<span class="f1">[test.sh]</span> FAILED: test_fail
<span class="f1">* test_fail</span>
<span class="f4">* [skipped] test_ok</span>
...
<span class="f4">[test.sh]</span>  at main(runtest/test/test_config_FAIL_FAST.sh:28)
...
<span class="f1">[test.sh]</span>  at _eval(runtest/test.sh:350)
<span class="f1">[test.sh]</span>  at assert_failure(runtest/test.sh:702)
<span class="f1">[test.sh]</span>  at main(runtest/test/test_config_FAIL_FAST.sh:34)
<span class="f1">[test.sh]</span> FAILED: test_fail
<span class="f1">* test_fail</span>
<span class="f4">[test.sh]</span> Start test: test_ok
<span class="f2">[test.sh]</span> PASSED: test_ok
<span class="f2">* test_ok</span>
<span class="f1">[test.sh]</span> 1 test(s) failed
<span class="f4">[test.sh]</span> Expected failure:
<span class="f4">[test.sh]</span> implicit exception: Error in _eval(runtest/test.sh:1): 'eval '{ pop_exit_handler;' &quot;$@&quot; '; } 2&gt;&amp;5'' exited with status 1
<span class="f4">[test.sh]</span>  at assert_failure(runtest/test.sh:702)
<span class="f4">[test.sh]</span>  at main(runtest/test/test_config_FAIL_FAST.sh:34)
