...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: In managed mode and FAIL_FAST true when a test fails the remaining tests should be displayed as skipped in the main output
<span class="f2">[test.sh]</span> PASSED: In managed mode and FAIL_FAST true when a test fails the remaining tests should be displayed as skipped in the main output
</pre>
</body>
</html>
