...
---
# Output of test_regression_33.sh
...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: Regression #33: when an include file is matched by more than one glob in INCLUDE_PATH, it is included only once
<span class="f2">[test.sh]</span> PASSED: Regression #33: when an include file is matched by more than one glob in INCLUDE_PATH, it is included only once
</pre>
</body>
</html>
