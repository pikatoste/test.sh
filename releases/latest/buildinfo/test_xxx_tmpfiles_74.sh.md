...
---
# Output of test_xxx_tmpfiles_74.sh
...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: #74: Ensure temporary files are cleaned after running all tests
<span class="f2">[test.sh]</span> PASSED: #74: Ensure temporary files are cleaned after running all tests
</pre>
</body>
</html>
