...
---
# Output of test_validate_value_56.sh
...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: validate_value() should print a comma-separated list of allowes values (#56)
<span class="f2">[test.sh]</span> PASSED: validate_value() should print a comma-separated list of allowes values (#56)
</pre>
</body>
</html>
