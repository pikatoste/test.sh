...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: #71: Assertion failures should not disable further error reporting
WARN: teardown_test failed
* test_01
WARN: teardown_test_suite failed
<span class="f2">[test.sh]</span> PASSED: #71: Assertion failures should not disable further error reporting
</pre>
</body>
</html>
