...
teardown_test_suite
<span class="f1">[test.sh]</span> implicit exception: Error in teardown_test_suite(runtest/test/do_test_teardown.sh:6): 'false' exited with status 1
<span class="f1">[test.sh]</span>  at call_teardown(runtest/test.sh:494)
<span class="f1">[test.sh]</span>  at run_tests(runtest/test.sh:643)
<span class="f1">[test.sh]</span>  at main(runtest/test/do_test_teardown.sh:21)
</pre>
</body>
</html>
