...
---
# Output of test_eval_syntax_error.sh
...
<span class="f4">[test.sh]</span> Start test: #98: eval syntax errors in the expression of assert_success are reported as such and not as an assertion failure
<span class="f2">[test.sh]</span> PASSED: #98: eval syntax errors in the expression of assert_success are reported as such and not as an assertion failure
<span class="f4">[test.sh]</span> Start test: #98: eval syntax errors in the expression of assert_failure are reported as such and not as an assertion failure
<span class="f2">[test.sh]</span> PASSED: #98: eval syntax errors in the expression of assert_failure are reported as such and not as an assertion failure
<span class="f4">[test.sh]</span> Start test: #98: eval syntax errors in try/catch nonzero are not caught
<span class="f2">[test.sh]</span> PASSED: #98: eval syntax errors in try/catch nonzero are not caught
</pre>
</body>
</html>
