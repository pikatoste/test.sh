...
---
# Output of test_assert_escaping_62.sh
...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: #62: The expression passed to assert_success should reach the evaluation point unchanged
<span class="f4">[test.sh]</span> Expected failure:
<span class="f4">[test.sh]</span> implicit exception: Error in _eval(runtest/test.sh:350): '[[ V1 = &quot;V1 V2&quot; ]]' exited with status 1
<span class="f4">[test.sh]</span>  at assert_failure(runtest/test.sh:702)
<span class="f4">[test.sh]</span>  at main(runtest/test/test_assert_escaping_62.sh:13)
<span class="f4">[test.sh]</span> Expected failure:
<span class="f4">[test.sh]</span> implicit exception: Error in _eval(runtest/test.sh:350): '[[ V1 = &quot;&quot; ]]' exited with status 1
<span class="f4">[test.sh]</span>  at assert_failure(runtest/test.sh:702)
<span class="f4">[test.sh]</span>  at main(runtest/test/test_assert_escaping_62.sh:15)
<span class="f2">[test.sh]</span> PASSED: #62: The expression passed to assert_success should reach the evaluation point unchanged
</pre>
</body>
</html>
