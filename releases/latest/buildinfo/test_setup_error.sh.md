...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: When setup_test_suite fails, an error message should be displayed in the main output
<span class="f2">[test.sh]</span> PASSED: When setup_test_suite fails, an error message should be displayed in the main output
<span class="f4">[test.sh]</span> Start test: When setup_test fails a failed test error message should be displayed in the main output
<span class="f2">[test.sh]</span> PASSED: When setup_test fails a failed test error message should be displayed in the main output
</pre>
</body>
</html>
