...
---
# Output of test_run_test_script_63.sh
...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: #63: run_test_script() interprets relative paths from the current script
<span class="f2">[test.sh]</span> PASSED: #63: run_test_script() interprets relative paths from the current script
</pre>
</body>
</html>
