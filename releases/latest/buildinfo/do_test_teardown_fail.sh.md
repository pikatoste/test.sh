...
---
# Output of do_test_teardown_fail.sh
...
[test.sh] implicit exception: Error in teardown_test(runtest/test/do_test_teardown_fail.sh:10): 'false' exited with status 1
[test.sh]  at call_teardown(runtest/test.sh:494)
[test.sh]  at run_tests(runtest/test.sh:621)
[test.sh]  at main(runtest/test/do_test_teardown_fail.sh:19)
[test.sh] PASSED: test_01
[test.sh] implicit exception: Error in teardown_test_suite(runtest/test/do_test_teardown_fail.sh:5): 'false' exited with status 1
[test.sh]  at call_teardown(runtest/test.sh:494)
[test.sh]  at run_tests(runtest/test.sh:643)
[test.sh]  at main(runtest/test/do_test_teardown_fail.sh:19)
</pre>
</body>
</html>
