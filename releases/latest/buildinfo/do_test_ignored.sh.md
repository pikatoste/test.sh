...
<span class="f1">[test.sh]</span> implicit exception: Error in test_01(runtest/test/do_test_ignored.sh:6): 'false' exited with status 1
<span class="f1">[test.sh]</span>  at run_tests(runtest/test.sh:616)
<span class="f1">[test.sh]</span>  at main(runtest/test/do_test_ignored.sh:14)
