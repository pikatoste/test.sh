...
---
# Output of test_regression_31.sh
...
<span class="f4">[test.sh]</span> Start test: Regression #31: double error reporting
<span class="f2">[test.sh]</span> PASSED: Regression #31: double error reporting
</pre>
</body>
</html>
