...
---
# Output of test_validate_values_56.sh
...
<body class="f9 b9">
<pre>
<span class="f4">[test.sh]</span> Start test: validate_values() should print a comma-separated list of allowes values (#56)
<span class="f2">[test.sh]</span> PASSED: validate_values() should print a comma-separated list of allowes values (#56)
</pre>
</body>
</html>
