...
<span class="f1">[test.sh]</span>  at main(runtest/test/do_test_STACK_TRACE.sh:15)
...
<span class="f1">[test.sh]</span> Error in run_tests(runtest/test.sh:220): '[[ $failures == 0 ]]' exited with status 1
<span class="f1">[test.sh]</span>  at main(runtest/test/do_test_STACK_TRACE.sh:17)
</pre>
</body>
</html>
