...
<span class="f1">[test.sh]</span> Error in func2(runtest/test/do_test_STACK_TRACE.sh:11): 'false' exited with status 1
<span class="f1">[test.sh]</span>  at func1(runtest/test/do_test_STACK_TRACE.sh:7)
<span class="f1">[test.sh]</span>  at test_01(runtest/test/do_test_STACK_TRACE.sh:16)
<span class="f1">[test.sh]</span>  at run_tests(runtest/test.sh:395)
<span class="f1">[test.sh]</span>  at @run_tests(runtest/test.sh:63)
<span class="f1">[test.sh]</span>  at main(runtest/test/do_test_STACK_TRACE.sh:19)
