...
<span class="f4">[test.sh]</span> Start test: Exceptions should be caugh in the catch block
<span class="f2">[test.sh]</span> PASSED: Exceptions should be caugh in the catch block
<span class="f4">[test.sh]</span> Start test: Exceptions in the catch block should not overwrite the current exception or _TRY_EXIT_CODE
<span class="f2">[test.sh]</span> PASSED: Exceptions in the catch block should not overwrite the current exception or _TRY_EXIT_CODE
<span class="f4">[test.sh]</span> Start test: Exceptions thrown from a catch block should ignore the current exception
<span class="f2">[test.sh]</span> PASSED: Exceptions thrown from a catch block should ignore the current exception
<span class="f4">[test.sh]</span> Start test: Try blocks that do exit with non-zero with no exit command and no ERR trap, generate exception
<span class="f1">[test.sh]</span> implicit exception: Error in main(runtest/test/test_exceptions.sh:37): 'false' exited with status 1
<span class="f2">[test.sh]</span> PASSED: Try blocks that do exit with non-zero with no exit command and no ERR trap, generate exception
<span class="f4">[test.sh]</span> Start test: Try blocks that exit do not generate exception and propagate exit
...
<span class="f4">[test.sh]</span>  at main(runtest/test/test_exceptions.sh:47)
<span class="f2">[test.sh]</span> PASSED: Try blocks that exit do not generate exception and propagate exit
<span class="f4">[test.sh]</span> Start test: Nested try/catch blocks do not repeat exceptions if rethrown
<span class="f1">[test.sh]</span> implicit exception: Error in main(runtest/test/test_exceptions.sh:52): 'false' exited with status 1
<span class="f2">[test.sh]</span> PASSED: Nested try/catch blocks do not repeat exceptions if rethrown
<span class="f4">[test.sh]</span> Start test: Nested try/catch blocks do not repeat exceptions if uncaught
<span class="f1">[test.sh]</span> error exception: Error
<span class="f1">[test.sh]</span>  at main(runtest/test/test_exceptions.sh:63)
<span class="f2">[test.sh]</span> PASSED: Nested try/catch blocks do not repeat exceptions if uncaught
<span class="f4">[test.sh]</span> Start test: Pending exceptions are not lost
<span class="f1">[test.sh]</span> implicit exception: Error in main(runtest/test/test_exceptions.sh:74): 'false' exited with status 1
<span class="f1">[test.sh]</span> <span class="f1">Previous exception:</span>
<span class="f1">[test.sh]</span> implicit exception: Error in main(runtest/test/test_exceptions.sh:73): 'false' exited with status 1
<span class="f1">[test.sh]</span> <span class="f1">Previous exception:</span>
<span class="f1">[test.sh]</span> implicit exception: Error in main(runtest/test/test_exceptions.sh:73): 'false' exited with status 1
<span class="f2">[test.sh]</span> PASSED: Pending exceptions are not lost
<span class="f4">[test.sh]</span> Start test: Exceptions in a subshell environment duplicate the exception (undesired feature)
<span class="f1">[test.sh]</span> implicit exception: Error in main(runtest/test/test_exceptions.sh:83): '$(false)' exited with status 1
<span class="f1">[test.sh]</span> <span class="f1">Previous exception:</span>
<span class="f1">[test.sh]</span> implicit exception: Error in main(runtest/test/test_exceptions.sh:83): 'false' exited with status 1
<span class="f2">[test.sh]</span> PASSED: Exceptions in a subshell environment duplicate the exception (undesired feature)
<span class="f4">[test.sh]</span> Start test: The catch block can select multiple exceptions
<span class="f1">[test.sh]</span> implicit exception: Error in main(runtest/test/test_exceptions.sh:91): 'false' exited with status 1
<span class="f1">[test.sh]</span> error exception: Error
<span class="f1">[test.sh]</span>  at main(runtest/test/test_exceptions.sh:96)
<span class="f2">[test.sh]</span> PASSED: The catch block can select multiple exceptions
<span class="f4">[test.sh]</span> Start test: The catch block does not catch non selected exceptions
<span class="f1">[test.sh]</span> pepe exception: Pepe
<span class="f1">[test.sh]</span>  at main(runtest/test/test_exceptions.sh:105)
<span class="f2">[test.sh]</span> PASSED: The catch block does not catch non selected exceptions
<span class="f4">[test.sh]</span> Start test: Implicit exceptions propagate the type of the existing pending exception
exception=pepe
<span class="f1">[test.sh]</span> pepe exception: Error in main(runtest/test/test_exceptions.sh:126): '( throw pepe &quot;Pepe&quot; )' exited with status 1
<span class="f1">[test.sh]</span> <span class="f1">Previous exception:</span>
<span class="f1">[test.sh]</span> pepe exception: Pepe
<span class="f1">[test.sh]</span>  at main(runtest/test/test_exceptions.sh:118)
<span class="f2">[test.sh]</span> PASSED: Implicit exceptions propagate the type of the existing pending exception
</pre>
</body>
</html>
